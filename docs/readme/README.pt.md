...
A primeira pergunta seleciona o idioma do instalador; English é o padrão. Depois, o menu principal mostra as oito etapas e a opção de desinstalação/redefinição.
